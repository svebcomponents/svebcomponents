...
:::note[Beta]
The Astro integration may change before 1.0.
:::
...
Astro can await its element wrapper. Enable Svelte's async server mode in
frontmatter that runs before the renderer import:
