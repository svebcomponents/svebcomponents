...
| `svelteOutDir`     | `undefined`                     | Writes a browser build that leaves Svelte for the host resolver.                         |
| `ssr`              | `true`                          | Generates server output.                                                                 |
| `ssrOutDir`        | `"dist/server"`                 | Writes the standalone server build.                                                      |
| `ssrSvelteOutDir`  | `undefined`                     | Writes server output that leaves Svelte for the host resolver.                           |
